 ...
 * Premium authentication portal allowing sales teams to access the CRM backend.
 */
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-inter">
      ...
      <div className="absolute bottom-1/4 right-10 w-80 h-80 bg-secondary/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md z-10">
        ...
        <p className="mt-2 text-center text-sm text-text-gray font-medium">
          Manage your startup sales pipeline and convert leads faster.
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md z-10">
        <div className="bg-card border border-slate-200/80 py-8 px-6 shadow-xl rounded-3xl sm:px-10 backdrop-blur-sm">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2.5 cursor-pointer group">
                ...
                />
                <span className="text-xs font-semibold text-text-gray group-hover:text-text-dark transition-colors">
          ...
          {/* Link to Registration Page & Demo fill */}
          <div className="mt-6 text-center border-t border-slate-100 pt-6 space-y-3">
            <button
              type="button"
              onClick={handleFillDemo}
              className="text-xs font-semibold text-indigo-600 hover:text-indigo-800 bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-lg transition-all cursor-pointer"
            >
